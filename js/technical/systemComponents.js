    ...
    'options-tab': {
        ...
        <table>
            <tr>
                ...
                <td><button class="opt" onclick="hardReset()">删除存档</button></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td><button class="opt" onclick="toggleOpt('hqTree')">高画质: {{ options.hqTree?"开":"关" }}</button></td>
            </tr>
            <tr>
                <td><button class="opt" onclick="toggleOpt('hideChallenges')">Completed Challenges: {{ options.hideChallenges?"HIDDEN":"SHOWN" }}</button></td>
                <td><button class="opt" onclick="toggleOpt('forceOneTab'); needsCanvasUpdate = true">单层级模式: {{ options.forceOneTab?"一直":"自动" }}</button></td>
